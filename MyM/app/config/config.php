...
*/
  ...
  define('ROOT_RELATIVE_PATH', './'); // from mym to root dir
  define('APP_RELATIVE_PATH', './app'); // from root to app dir
  if (!defined('MYM_RELATIVE_PATH')) define('MYM_RELATIVE_PATH', './'); // from root to mym dir
    
  // TODO avoid this crossed referencing

  // app URI
  define("ROOT_URI", "http://localhost/test/MyM");
  // app admin email (for errors/warnings)
  define("MYM_ADMIN_EMAIL", "giovanni@mexpro.it");
  ...
  // multilanguage static words path (relative to app directory)
  define("MYM_LANGUAGES_PATH", "./lng");

  // Structure and modules
  // structures definition path (relative to app directory)
  define("MYM_STRUCTURES_PATH", "./structures/sources");  
  // modules definition path (relative to app directory)
  ...
  define("MYM_TXTDB_PATH", "./app/txtdb");
  // mym static arrays (for examples preferences), comment to disable
  // path (relative to root directory)
  define("MYM_INI_PATH", "./app/ini");

  // MySQL Database // comment to disable
   // define("MYM_MYSQL", "1");
  ...
  // MySQL table prefix  
  define("MYM_MYSQL_PREFIX", "");

  ///////////////////////////////////////// User Management
  // MyM Users' DB 
  // If user management is not used, this must be commented
